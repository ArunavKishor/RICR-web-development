        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredRestaurants.map((restaurant) => (
              ...
              >
                <div className="h-40 bg-gradient-to-brown from-orange-400 to-orange-500 flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {popularDishes.map((dish) => (
              ...
              >
                <div className="h-48 bg-gradient-to-brown from-orange-300 to-orange-400 flex items-center justify-center">
